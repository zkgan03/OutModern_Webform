<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="500.aspx.cs" Inherits="OutModern.src.ErrorPages._500" %>
...
<body>
    ...
    <div id="error">Error : Internal Server Error</div>
    <div class="error-num">
        500
    ...
    <p>
        ...
        <asp:HyperLink runat="server" NavigateUrl="~/src/Client/Home/Home.aspx">a way out</asp:HyperLink>
    </p>
    <!-- partial -->
</body>
</html>

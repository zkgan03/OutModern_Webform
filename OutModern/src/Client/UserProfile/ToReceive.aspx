<%@ Page Language="C#" MasterPageFile="~/src/Client/ClientMaster/Client.Master" AutoEventWireup="true" CodeBehind="ToReceive.aspx.cs" Inherits="OutModern.src.Client.UserProfile.ToReceive" %>
        ...
        <div class="columns-containColumn">
            ...
            <div class="column2">
                ...
                <div class="boxRightTop">
                    ...
                    <asp:Button ID="btn_to_receive" runat="server" Text="To Receive" class="btn_myOrder1" Style="background-color: black;" OnClick="btn_to_receive_Click" />
                ...
                <div class="boxRightBottom">
                    ...
                    <div class="repeater_items">
                        ...
                        <div class="box2">
                            ...
                            <div class="box2small">
                                <asp:Label ID="lbl_product_size" runat="server" Text="Size: M" class="box2_product_size"></asp:Label>
                            </div>
                        ...
                        <div class="box4">
                            <asp:Button ID="btn_order_receive" runat="server" Text="Order Received" CssClass="bg-black hover:bg-gray-700" Style="font-family: sans-serif; color: white; font-size: 1rem; font-weight: bold; border-radius: 1.25rem; 
    padding: 0.625rem 1.25rem; margin-left: 0.625rem; cursor: pointer;" />
                        </div>
                ...
                <asp:ListView
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton
                                    Visible='<%# Eval("OrderStatusName").ToString() == "Shipped" %>'
                                    CssClass="shipped-button bg-red-500 text-white"
                                    CommandName="ToShipped"
                                    CommandArgument='<%# Eval("OrderId") %>'
                                    ID="lbStatusCancel" runat="server">Receive Order
                                </asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
